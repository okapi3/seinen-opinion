...
<title><?php if ( is_home() || is_front_page() ) : ?>青年の日<?php else : ?><?php the_title(); ?> | 青年の日<?php endif; ?></title>
...
<?php elseif (is_page_template('sdgs/what.php') || is_page_template('sdgs/mission.php') || is_page_template('sdgs/sdgs.php') || is_page_template('sdgs/17goals.php'))  : ?>
			...
			<div class="header-container">
				<div class="header-logo">
					<a href="<?php echo esc_url( get_home_url() ); ?>" class="header-logo__link">
						<img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/top/img_header-logo.svg" alt="">
					</a>
				</div>

				<h1 class="">
					<a href="<?php echo esc_url( get_home_url() ); ?>" class="header-logo__link">
						<img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/top/img_header-txt.svg" alt="">
					</a>
				</h1>
